...
Widget _buildActivity() {
  ...
  return Padding(
    ...
    child: Column(
      ...
      children: [
        Text("Aktivitas", style: AppStyle.caption1(color: AppStyle.black500)),
        SizedBox(height: 6),
        Text(
          "Pastikan akunmu aman dengan memantau aktivitas login, register hingga notiikasi OTP.",
          style: AppStyle.caption1(color: AppStyle.black400),
        ),
        SizedBox(height: 6),
        Row(
...
Widget _buildReminder() {
  ...
  return Padding(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("Pengingat", style: AppStyle.caption1(color: AppStyle.black500)),
        SizedBox(height: 6),
        Text(
