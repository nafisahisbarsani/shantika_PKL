  ...
  Widget _buildBusTypes() {
    return Padding(
      ...
      child: CustomCardContainer(
        ...
        statusColor: AppStyle.seat,
        statusText: "2 Penumpang",
        statusTextColor: AppStyle.primary1,
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      'Total Pembayaran',
                      style: AppStyle.paragraph1(color: AppStyle.black400),
                    ),
                    Text(
                      'Rp380.000',
      ...
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(title, style: AppStyle.paragraph1(color: AppStyle.black400)),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(title, style: AppStyle.paragraph1(color: AppStyle.black400)),
              SizedBox(height: AppStyle.spaceXS),
              Text(value, style: AppStyle.caption3(color: AppStyle.black500)),
            ],
          ),
        ),
      ],
    ...
    children: [
      ...
      Expanded(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(title, style: AppStyle.paragraph1(color: textColor)),
            SizedBox(height: AppStyle.spaceXS),
            Text(
              subtitle,
